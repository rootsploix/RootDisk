...
*Advanced disk forensics and recovery tool*

</div>

## 🚀 Overview

**RootDisk** is a professional-grade digital forensics tool designed for cybersecurity professionals, penetration testers, and security researchers. Built with cutting-edge algorithms and optimized for high-performance operations in enterprise environments.
...
```bash
git clone https://github.com/rootsploix/RootDisk.git
cd RootDisk
pip install -r requirements.txt
python rootdisk.py --help
```
...
```bash
python rootdisk.py --target example.com --license DEMO
```

### Professional Mode (License Required)
```bash
python rootdisk.py --target example.com --license RXPRO-XXXXX-XXXXX-XXXXX-XXXXX
```
...
- **Professional License**: $649 (Lifetime Access)
- **Enterprise License**: $1499 (Multiple Users + Source Code)

### 🛒 Purchase Options

- [**Buy Professional License**](https://rootsploix.gumroad.com/rootdisk-pro)
- [**Buy Enterprise License**](https://rootsploix.gumroad.com/rootdisk-enterprise)
...
- [**User Manual**](https://docs.rootsploix.com/rootdisk)
- [**API Reference**](https://api.rootsploix.com/rootdisk)
...
[**View Full Changelog**](https://github.com/rootsploix/RootDisk/releases)
